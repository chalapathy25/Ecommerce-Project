...
<body>
  <div class="div1">
    <form action="register">
      ...
      <input type="password" name="cpassword" required="required" placeholder="Confirm Password"><br><br>
      <input type="email" name="email" required="required" placeholder="Email"><br><br>
      <input type="text" name="phoneNumber" required="required" placeholder="Phone Number"><br><br>
